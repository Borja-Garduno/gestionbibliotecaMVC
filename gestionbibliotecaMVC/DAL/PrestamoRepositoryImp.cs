    ...
    public class PrestamoRepositoryImp : PrestamoRepository
        ...
        public Prestamo create(Prestamo prestamo) {
            ...
            using (SqlConnection conexion = new SqlConnection(conexionString)) {
                ...
                command.Parameters.Add("@codPrestamo", SqlDbType.Int).Direction = ParameterDirection.Output;
                conexion.Open();

                command.ExecuteNonQuery();

                prestamo.CodPrestamo = Convert.ToInt32(command.Parameters["@codPrestamo"].Value);
